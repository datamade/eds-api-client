...
class EDSWebClient(scrapelib.RetrySession):
    ...
    """
    def __init__(self, username, password, domain='https://webapps1qa.chicago.gov/eds'):
    ...
    def get_eds_pdf(self, eds_id):
        ...
        if not eds_id:
            ...
            if login_response.status_code == 200:
                eds_pdf_url = '{domain}/pdf/single/{eds_id}'.format(domain=self.domain, eds_id=eds_id)
