...
SESSION_DATA = {
    ...
    "employees": {
        "boolean": 1,
        "employees": [
            {"first_name": "Rahm", "last_name": "Emanuel", "position": "Mayor"}
        ],
    },
    ...
    "individual_criminal_history": {
        "individual_criminal_history": {"boolean": 0, "expl": ""}
    },
    "group_criminal_history": {
        "group_criminal_history": {"boolean": 1, "expl": "live together, die alone"}
    },
    "disqualifications": {
        "bid_rigging": {"boolean": 0, "expl": ""},
        "sanctions_list": {"boolean": 1, "expl": '"most likely to succeed"'},
    },
    "problem_properties": {
        "boolean": 1,
        "problem_properties": [
    ...
    "conduct_compliance": {"conduct_compliance": {"boolean": 0, "expl": ""}},
    "child_support_compliance": {"behind_on_child_support": 0},
    "payment_and_hiring_compliance": {
        "payment_compliance": {"boolean": 0, "expl": ""},
        "environmental_compliance": {"boolean": 1, "expl": "don't tread on me"},
        "hiring_compliance": {"boolean": 0, "expl": ""},
    },
